...
#include <memory>
#include "../../../app/platform_unix/basewindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BaseWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_BaseWindow_t qt_meta_stringdata_BaseWindow = {
    {
        QT_MOC_LITERAL(0, 10),  // "BaseWindow"
        QT_MOC_LITERAL(11, 8),  // "exitLoop"
        QT_MOC_LITERAL(20, 0)   // ""
    },
    "BaseWindow",
    "exitLoop",
...
Q_CONSTINIT static const uint qt_meta_data_BaseWindow[] = {
...
Q_CONSTINIT const QMetaObject BaseWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_BaseWindow.offsetsAndSizes,
    qt_meta_data_BaseWindow,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_BaseWindow_t,
        // Q_OBJECT / Q_GADGET
...
void BaseWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->exitLoop((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BaseWindow::*)(int );
            if (_t _q_method = &BaseWindow::exitLoop; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BaseWindow::exitLoop(int _t1)
{
