...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Tables_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Tables_t qt_meta_stringdata_Tables = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Tables[] = {
...
Q_CONSTINIT const QMetaObject Tables::staticMetaObject = { {
    ...
    qt_meta_stringdata_Tables.offsetsAndSizes,
    qt_meta_data_Tables,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Tables_t,
        // Q_OBJECT / Q_GADGET
