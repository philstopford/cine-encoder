...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BaseDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_BaseDialog_t qt_meta_stringdata_BaseDialog = {
    {
        QT_MOC_LITERAL(0, 10)   // "BaseDialog"
    },
    "BaseDialog"
};
...
Q_CONSTINIT static const uint qt_meta_data_BaseDialog[] = {
...
Q_CONSTINIT const QMetaObject BaseDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_BaseDialog.offsetsAndSizes,
    qt_meta_data_BaseDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_BaseDialog_t,
        // Q_OBJECT / Q_GADGET
